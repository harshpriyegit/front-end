  ...
  const plans = [
    {
      ...
      features: ["Google Ads - 2 Campaigns", "Meta Ads - 2 Campaigns", "Complete Ads Setup", "Basic Targeting", "Monthly Performance Summary"],
      popular: false,
    },
    {
      name: "Professional",
      ...
      features: ["15 Professionally Designed Posts / Month", "Creative Captions + Hashtag Strategy", "Page Optimization", "Monthly Insights Report", "Comment + DM Assistance (basic)"],
      popular: true,
    },
    {
      name: "Enterprise",
      ...
      features: ["Google + Meta Ads Management", "Social Media Content (Custom Volume)", "Strategy + Funnel Planning", "Custom Creatives (Images + Reels)", "Priority Support"],
      popular: false,
    },
  ]
