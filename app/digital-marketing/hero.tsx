      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="z-10 space-y-8">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight animate-slide-in-left-delayed">
              <span className="text-white">Grow Faster With</span>
              <br/>
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-xl leading-relaxed animate-fade-in-slow">
              We help brands scale with targeted ads, smart automation, and high-converting strategies that deliver real results.
            </p>
