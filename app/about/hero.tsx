      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="z-10 space-y-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-5xl font-bold leading-tight animate-slide-in-left-delayed">
              <span className="text-white">We Build Brands That </span>
              <br/>
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-xl leading-relaxed animate-fade-in-slow">
              A full-service digital agency blending strategy, design, marketing, and production to help businesses create impact and scale with confidence.
            </p>
