        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="z-10 space-y-8">
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-xl leading-relaxed animate-fade-in-slow">
              We craft cutting-edge websites and digital solutions that captivate audiences, build trust, and drive measurable growth for forward-thinking businesses.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-slower ">
              ...
              >
                ...
                <div className="absolute inset-0 bg-[#4C97BC] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </Link>
              }/>
